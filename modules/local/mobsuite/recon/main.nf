process MOBSUITE_RECON {
   ...
   conda "bioconda::mob_suite=3.1.9"
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/mob_suite%3A3.1.9--pyhdfd78af_1':
        'biocontainers/mob_suite%3A3.1.9--pyhdfd78af_1' }"
    ...
    tuple val(meta), path("*contig_report.plasmid.csv")   , emit: plasmid_contig_report, optional: true
    ...
    tuple val(meta), path("*mge_report.txt"), emit: mge_report, optional: true
